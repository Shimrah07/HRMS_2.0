...
namespace IndiaHRMS.Infrastructure.Migrations
{
    ...
    [Migration("20260804112545_AddExitManagementModule")]
    partial class AddExitManagementModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.ExpenseLineItem", b =>
                {
                    ...
                    b.Property<decimal>("ClientMarkupPercent")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.OcrExtractionLog", b =>
                {
                    ...
                    b.Property<string>("ExtractedGstin")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("LineItemId")
                        .IsUnique()
                        .HasFilter("[LineItemId] IS NOT NULL");

                    b.ToTable("OcrExtractionLogs");
                });
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.ReimbursementBatch", b =>
                {
                    ...
                    b.ToTable("ReimbursementBatches");
                });
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.SectorPolicyConfig", b =>
                {
                    b.Property<Guid>("SectorConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelAdvance", b =>
                {
                    ...
                    b.Property<decimal>("EstimatedTripCost")
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelBooking", b =>
                {
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelEntitlement", b =>
                {
                    ...
                    b.Property<decimal>("DAMetro")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("DANonMetro")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.ToTable("TravelEntitlements");
                });

            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelPolicyException", b =>
                {
                    b.Property<Guid>("ExceptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("AdditionalCostImpact")
                        .HasColumnType("decimal(12,2)");

                    b.Property<Guid?>("ApprovedByFinance")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ApprovedByHOD")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EntitledCategory")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TravelPolicyExceptions");
                });

            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelRequest", b =>
                {
                    ...
                    b.Property<string>("TravelInsuranceInfo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.ExpenseClaim", b =>
                {
                    ...
                    b.HasOne("IndiaHRMS.Domain.Entities.TravelRequest", "TravelRequest")
                        .WithOne("ExpenseClaim")
                        .HasForeignKey("IndiaHRMS.Domain.Entities.ExpenseClaim", "TravelRequestId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.ExpenseLineItem", b =>
                {
                    b.HasOne("IndiaHRMS.Domain.Entities.ExpenseClaim", "Claim")
                        .WithMany("LineItems")
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.OcrExtractionLog", b =>
                {
                    b.HasOne("IndiaHRMS.Domain.Entities.ExpenseLineItem", "LineItem")
                        .WithOne("OcrLog")
                        .HasForeignKey("IndiaHRMS.Domain.Entities.OcrExtractionLog", "LineItemId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelAdvance", b =>
                {
                    ...
                    b.HasOne("IndiaHRMS.Domain.Entities.TravelRequest", "TravelRequest")
                        .WithOne("Advance")
                        .HasForeignKey("IndiaHRMS.Domain.Entities.TravelAdvance", "TravelRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelBooking", b =>
                {
                    b.HasOne("IndiaHRMS.Domain.Entities.TravelRequest", "TravelRequest")
                        .WithOne("Booking")
                        .HasForeignKey("IndiaHRMS.Domain.Entities.TravelBooking", "TravelRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IndiaHRMS.Domain.Entities.TravelPolicyException", b =>
                {
                    b.HasOne("IndiaHRMS.Domain.Entities.TravelRequest", "TravelRequest")
                        .WithOne("PolicyException")
                        .HasForeignKey("IndiaHRMS.Domain.Entities.TravelPolicyException", "TravelRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
