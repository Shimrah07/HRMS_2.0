    ...
    <AnimatePresence>
      {commandPaletteOpen && (
        ...
        >
          ...
          >
            {/* Search Input */}
            <div style={{ padding: '12px 16px', borderBottom: isDarkMode ? '1px solid rgba(160, 90, 255, 0.18)' : '1px solid rgba(16, 17, 63, 0.08)' }}>
              <Input
                autoFocus
                prefix={<SearchOutlined style={{ color: isDarkMode ? 'rgba(200, 160, 255, 0.55)' : 'rgba(16, 17, 63, 0.35)' }} />}
            ...
            <div style={{ maxHeight: 360, overflowY: 'auto', padding: '8px 0' }}>
                ...
                <div key={category}>
                  ...
                  {cmds.map((cmd, idx) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: isSelected
                            ? (isDarkMode ? 'rgba(160, 90, 255, 0.12)' : 'rgba(16, 17, 63, 0.04)')
                            : 'transparent',
                      ...
                      >
                        <span style={{ color: isSelected ? (isDarkMode ? '#FAA71A' : '#10113F') : (isDarkMode ? 'rgba(200, 160, 255, 0.55)' : 'rgba(16, 17, 63, 0.4)'), fontSize: 16 }}>
                          {cmd.icon}
                        </span>
              ...
              {filtered.length === 0 && (
                <div style={{ padding: '24px 16px', textAlign: 'center', color: isDarkMode ? 'rgba(240, 244, 255, 0.45)' : 'rgba(16, 17, 63, 0.45)', fontSize: 14 }}>
            ...
            {/* Footer */}
            <div style={{ padding: '8px 16px', borderTop: isDarkMode ? '1px solid rgba(160, 90, 255, 0.18)' : '1px solid rgba(16, 17, 63, 0.08)', display: 'flex', gap: 16 }}>
              {[
                { key: '↑↓', label: 'Navigate' },
                { key: '↵', label: 'Open' },
                { key: 'Esc', label: 'Close' },
                ...
                <div key={hint.key} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                  <kbd style={{
                    fontSize: 11,
                    background: isDarkMode ? 'rgba(160, 90, 255, 0.1)' : 'rgba(16, 17, 63, 0.04)',
                    color: isDarkMode ? 'rgba(200, 160, 255, 0.7)' : 'rgba(16, 17, 63, 0.6)',
                  ...
                  <span style={{ fontSize: 11, color: isDarkMode ? 'rgba(240, 244, 255, 0.45)' : 'rgba(16, 17, 63, 0.4)' }}>{hint.label}</span>
                </div>
              ))}
            </div>
          </motion.div>
