              ...
              {colApps.map(app => {
                ...
                return (
                  <Card key={app.appId} size="small" hoverable
                    ...
                    {(app.isBlacklisted || app.candidate?.isBlacklisted) && (
                      <div style={{ marginTop: 4 }}>
                        <Tag color="volcano" style={{ fontSize: 9.5, margin: 0, borderRadius: 4, fontWeight: 700 }}>
          ...
          <Tabs activeKey={drawerTab} onChange={setDrawerTab} items={[
            {
              ...
              children: (
                <div>
                  {(selectedApp.isBlacklisted || selectedApp.candidate?.isBlacklisted) && (
                    <Alert
                      type="error"
                      showIcon
                      message="⛔ Blacklisted Candidate Alert"
                      description={
                        selectedApp.blacklistReason ||
                        selectedApp.candidate?.blacklistReason ||
                        "This candidate has been blacklisted and should not be processed or hired."
                      }
