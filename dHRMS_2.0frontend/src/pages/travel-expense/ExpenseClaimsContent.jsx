...
import { Table, Card, Button, Modal, Form, Input, InputNumber, Select, Tag, Row, Col, Typography, message, Alert } from 'antd'
...
export const ExpenseClaimsContent = ({ submitModalOpen, setSubmitModalOpen }) => {
  ...
  const handleSubmitClaim = async () => {
    try {
      ...
      if (setSubmitModalOpen) setSubmitModalOpen(false)
      form.resetFields()
      fetchClaims()
    } catch (err) {
      console.error(err)
  ...
  return (
    <div>
      ...
      <Modal
        ...
        onCancel={() => setSubmitModalOpen && setSubmitModalOpen(false)}
        width={900}
      >
...
export default ExpenseClaimsContent
