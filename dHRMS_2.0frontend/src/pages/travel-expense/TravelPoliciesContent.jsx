...
import { SafetyCertificateOutlined, EditOutlined, GlobalOutlined, EnvironmentOutlined } from '@ant-design/icons'
import { travelExpenseService } from '../../services/travelExpenseService'

const { Text, Paragraph } = Typography

export const TravelPoliciesContent = ({ exceptionModalOpen, setExceptionModalOpen }) => {
  ...
  const handleRequestException = async () => {
    try {
      ...
      if (setExceptionModalOpen) setExceptionModalOpen(false)
  ...
  return (
    <div>
      ...
      <Modal
        ...
        onCancel={() => setExceptionModalOpen && setExceptionModalOpen(false)}
      >
...
export default TravelPoliciesContent
