...
import { Table, Card, Button, Modal, Form, Input, Select, DatePicker, Tag, Space, Drawer, Row, Col, Typography, message, Switch, Badge } from 'antd'
import { PlusOutlined, RocketOutlined, CheckCircleOutlined, ClockCircleOutlined, CloseCircleOutlined, FilePdfOutlined, GlobalOutlined } from '@ant-design/icons'
import { travelExpenseService } from '../../services/travelExpenseService'

const { Text, Title } = Typography
const { RangePicker } = DatePicker

export const TravelRequestsTab = () => {
      ...
      <Card
        title={
          <Space>
            ...
            <span>Travel Requests & Travel Desk Booking Hub</span>
          </Space>
        }
        extra={
