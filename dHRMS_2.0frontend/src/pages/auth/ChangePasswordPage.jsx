        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <div style={{ 
            ...
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
              <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z" fill={isDarkMode ? "#10113F" : "white"}/>
            </svg>
          </div>
          ...
          <p style={{ color: 'var(--color-text-secondary)', fontSize: 13.5, lineHeight: 1.5, margin: 0 }}>
            Your account requires a password change to establish your secure workspace.
          </p>
        </div>
        ...
        <div style={{
          ...
          {success ? (
            <div style={{ textAlign: 'center', padding: '16px 0' }}>
              ...
              <h2 style={{ color: '#22c55e', fontSize: 20, fontWeight: 700, marginBottom: 6 }}>Password Changed Successfully!</h2>
              <p style={{ color: 'var(--color-text-secondary)', fontSize: 13.5, margin: 0 }}>Establishing session and loading your dashboard...</p>
            </div>
          ) : (
